...
export default function CheackoutFrom() {
    ...
    return (
        <div className="grid grid-cols-1  md:grid-cols-2 gap-[390px]">
            ...
            <div className="sm:-w-[80px]  md:w-[800px] md: px-20 mb-8 py-5">
                ...
                <form onSubmit={handleSubmit((data) => console.log(data))} className="   gap-5 border-2 sm:  px-8 py-5">
                    ...
                    <div className="  py-3  flex gap-8 rounded-full w-9 -ml-6 mt-7">
                    ...
                    <div className="flex gap-[200px] mt-3">
                        ...
                        {errors.age && <p>Please enter number for age.</p>}
                        <label htmlFor="" className="grid ml-4 h-8 ">States
            ...
            <div className=" px-6">
                ...
                <div className="border-2 px-4 mt-4 rounded-md">
                    ...
                    <p><input type="radio"/> Cash on Deliveri</p>
